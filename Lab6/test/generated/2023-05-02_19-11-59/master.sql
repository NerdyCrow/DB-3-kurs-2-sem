...
PROMPT Dropping Role ROLE_test ...
DROP ROLE ROLE_test ;
PROMPT Creating Role ROLE_test ...
...
GRANT ALL ON utils TO ROLE_test;
...
GRANT ALL ON ContactCoordinate TO ROLE_test;
...
GRANT ALL ON Software TO ROLE_test;
...
GRANT ALL ON Owners TO ROLE_test;
...
GRANT ALL ON Licenses TO ROLE_test;
...
GRANT ALL ON LicensesHistory TO ROLE_test;
...
GRANT ALL ON Customers TO ROLE_test;
...
GRANT ALL ON Contacts TO ROLE_test;
...
PROMPT Creating Primary Key Constraint PK__Report__3213E83F0B0D2811 on table Report ... 
ALTER TABLE Report
ADD CONSTRAINT PK__Report__3213E83F0B0D2811 PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON Report TO ROLE_test;
...
;
PROMPT Creating Index XMLINDEX_SEC_1 on Report ...
CREATE INDEX XMLINDEX_SEC_1 ON Report
(
  xml_column
...
GRANT ALL ON vw_InactiveLicenses TO ROLE_test;
...
GRANT ALL ON vw_ActiveLicenses TO ROLE_test;
...
GRANT ALL ON vw_Unpayment TO ROLE_test;
...
END;
/
GRANT ALL ON CountOfCustLic TO ROLE_test;
...
END;
/
GRANT ALL ON CountOfLicenses TO ROLE_test;
...
END;
/
GRANT ALL ON fn_diagramobjects TO ROLE_test;
...
END;
/
GRANT ALL ON udf_TotalCostOfPurchasedLicenses TO ROLE_test;
...
END;
/
GRANT ALL ON AddSubordinate TO ROLE_test;
...
END;
/
GRANT ALL ON Distancecontact TO ROLE_test;
...
END;
/
GRANT ALL ON DistanceUser TO ROLE_test;
...
BEGIN
   ...
   OPEN  v_cursor FOR
      SELECT S.Name SoftwareName  ,
             S.Version SoftwareVersion  ,
             S.Price SoftwarePrice  ,
             o.ContactId OwnerContactId  ,
             c.ContactId CustomerContactId  ,
             l.Title LicenseTitle  ,
             l.PaymentDate LicensePaymentDate  ,
             l.ExpiryDate LicenseExpiryDate  ,
             lh.Title LicenseHistoryTitle  ,
             lh.PaymentDate LicenseHistoryPaymentDate  ,
             lh.ExpiryDate LicenseHistoryExpiryDate  ,
             SYSDATE TIMESTAMP  
        FROM Software S
               JOIN Owners o   ON S.OwnerId = o.Id
               JOIN Licenses l   ON S.Id = l.SoftwareId
...
END;
/
GRANT ALL ON GenerateXML TO ROLE_test;
...
END;
/
GRANT ALL ON GetClosestContact TO ROLE_test;
...
END;
/
GRANT ALL ON InsertReportXML TO ROLE_test;
...
END;
/
GRANT ALL ON MoveSubtree TO ROLE_test;
CREATE OR REPLACE PROCEDURE SelectData
(
  v_query IN NVARCHAR2
)
AS

BEGIN

   EXECUTE IMMEDIATE 'select xml_column.query(''' || v_query || ''') as [xml_column] from Report';

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON SelectData TO ROLE_test;
...
END;
/
GRANT ALL ON ShowSubordinates TO ROLE_test;
...
END;
/
GRANT ALL ON sp_alterdiagram TO ROLE_test;
...
END;
/
GRANT ALL ON sp_creatediagram TO ROLE_test;
...
END;
/
GRANT ALL ON sp_dropdiagram TO ROLE_test;
...
END;
/
GRANT ALL ON sp_helpdiagramdefinition TO ROLE_test;
...
END;
/
GRANT ALL ON sp_helpdiagrams TO ROLE_test;
...
END;
/
GRANT ALL ON sp_renamediagram TO ROLE_test;
...
END;
/
GRANT ALL ON sp_upgraddiagrams TO ROLE_test;
...
END;
/
GRANT ALL ON usp_AddCustomer TO ROLE_test;
...
END;
/
GRANT ALL ON usp_AddLicense TO ROLE_test;
...
END;
/
GRANT ALL ON usp_AddOwner TO ROLE_test;
...
END;
/
GRANT ALL ON usp_AddSoftware TO ROLE_test;
...
END;
/
GRANT ALL ON usp_Cross TO ROLE_test;
...
END;
/
GRANT ALL ON usp_DeleteLicense TO ROLE_test;
...
END;
/
GRANT ALL ON usp_EditLicense TO ROLE_test;
...
END;
/
GRANT ALL ON usp_GetLicenses TO ROLE_test;
...
END;
/
GRANT ALL ON usp_GetLicensesExpireNextMonth TO ROLE_test;
set define on
prompt connecting to SoftLicenseManagement
alter session set current_schema=SoftLicenseManagement;
set define off
