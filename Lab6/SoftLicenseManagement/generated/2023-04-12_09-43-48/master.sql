...
spool "SoftLicenseManagement_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_SoftLicenseManagement ...
DROP ROLE ROLE_SoftLicenseManagement ;
PROMPT Creating Role ROLE_SoftLicenseManagement ...
CREATE ROLE ROLE_SoftLicenseManagement ;

-- PROMPT Drop SoftLicenseManagement user
-- drop user SoftLicenseManagement cascade;
   
PROMPT Create user SoftLicenseManagement
CREATE USER SoftLicenseManagement IDENTIFIED BY &&SoftLicenseManagement_password PASSWORD EXPIRE ACCOUNT LOCK /* DEFAULT TABLESPACE USERS  TEMPORARY TABLESPACE TEMP */;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE SYNONYM, UNLIMITED TABLESPACE TO SoftLicenseManagement;
...
GRANT ALL ON utils TO ROLE_SoftLicenseManagement;
grant ALL on utils to SoftLicenseManagement with grant option;

set define on
prompt connecting to SoftLicenseManagement
alter session set current_schema=SoftLicenseManagement;
set define off
-- DROP TABLE ContactCoordinate CASCADE CONSTRAINTS;


PROMPT Creating Table ContactCoordinate ...
CREATE TABLE ContactCoordinate (
...
PROMPT Creating Primary Key Constraint PK__UserLoca__3213E83F852516BE on table ContactCoordinate ... 
ALTER TABLE ContactCoordinate
ADD CONSTRAINT PK__UserLoca__3213E83F852516BE PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON ContactCoordinate TO ROLE_SoftLicenseManagement;
...
PROMPT Creating Primary Key Constraint PK__Software__3214EC07ED460441 on table Software ... 
ALTER TABLE Software
ADD CONSTRAINT PK__Software__3214EC07ED460441 PRIMARY KEY
(
  Id
)
ENABLE
...
GRANT ALL ON Software TO ROLE_SoftLicenseManagement;
-- DROP TABLE Owners CASCADE CONSTRAINTS;


PROMPT Creating Table Owners ...
CREATE TABLE Owners (
  Id NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
...
PROMPT Creating Primary Key Constraint PK__Owners__3214EC07EA773BE2 on table Owners ... 
ALTER TABLE Owners
ADD CONSTRAINT PK__Owners__3214EC07EA773BE2 PRIMARY KEY
(
  Id
)
ENABLE
...
GRANT ALL ON Owners TO ROLE_SoftLicenseManagement;
...
ALTER TABLE Licenses MODIFY (PaymentDate DEFAULT SYSDATE);
PROMPT Creating Primary Key Constraint PK__Licenses__3214EC0792EB56CD on table Licenses ... 
ALTER TABLE Licenses
ADD CONSTRAINT PK__Licenses__3214EC0792EB56CD PRIMARY KEY
(
  Id
)
ENABLE
...
GRANT ALL ON Licenses TO ROLE_SoftLicenseManagement;
-- DROP TABLE LicensesHistory CASCADE CONSTRAINTS;


PROMPT Creating Table LicensesHistory ...
...
ALTER TABLE LicensesHistory MODIFY (PaymentDate DEFAULT SYSDATE);
PROMPT Creating Primary Key Constraint PK__Licenses__3214EC073DAC5561 on table LicensesHistory ... 
ALTER TABLE LicensesHistory
ADD CONSTRAINT PK__Licenses__3214EC073DAC5561 PRIMARY KEY
(
  Id
)
ENABLE
...
GRANT ALL ON LicensesHistory TO ROLE_SoftLicenseManagement;
...
PROMPT Creating Primary Key Constraint PK__Customer__3214EC0793681B02 on table Customers ... 
ALTER TABLE Customers
ADD CONSTRAINT PK__Customer__3214EC0793681B02 PRIMARY KEY
(
  Id
)
ENABLE
...
GRANT ALL ON Customers TO ROLE_SoftLicenseManagement;
-- DROP TABLE Contacts CASCADE CONSTRAINTS;


PROMPT Creating Table Contacts ...
CREATE TABLE Contacts (
  Id NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  Name NVARCHAR2(75) NOT NULL,
  Email NVARCHAR2(75) NOT NULL,
  Address NVARCHAR2(75),
  Phone NVARCHAR2(75),
  ParentId NUMBER(10,0)
);


PROMPT Creating Primary Key Constraint PK__Contacts__3214EC0731286984 on table Contacts ... 
ALTER TABLE Contacts
ADD CONSTRAINT PK__Contacts__3214EC0731286984 PRIMARY KEY
(
  Id
)
ENABLE
...
GRANT ALL ON Contacts TO ROLE_SoftLicenseManagement;
PROMPT Creating Index IX_Software_OwnerId on Software ...
CREATE INDEX IX_Software_OwnerId ON Software
(
  OwnerId
) 
;
PROMPT Creating Index IX_Owners_ContactId on Owners ...
CREATE INDEX IX_Owners_ContactId ON Owners
(
  ContactId
) 
;
PROMPT Creating Index IX_Licenses_SoftwareId on Licenses ...
CREATE INDEX IX_Licenses_SoftwareId ON Licenses
(
  SoftwareId
) 
;
PROMPT Creating Index IX_Licenses_CustomerId on Licenses ...
CREATE INDEX IX_Licenses_CustomerId ON Licenses
(
  CustomerId
) 
;
PROMPT Creating Index IX_Customers_ContactId on Customers ...
CREATE INDEX IX_Customers_ContactId ON Customers
(
  ContactId
) 
;
...
alter session set current_schema=SoftLicenseManagement;
set define off
CREATE OR REPLACE FORCE VIEW vw_InactiveLicenses 
AS 
   SELECT l.Id ,
          l.Title ,
          l.PaymentDate ,
...
GRANT ALL ON vw_InactiveLicenses TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FORCE VIEW vw_ActiveLicenses 
AS 
   SELECT l.Id ,
          l.Title ,
          l.PaymentDate ,
...
GRANT ALL ON vw_ActiveLicenses TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FORCE VIEW vw_Unpayment 
AS 
   SELECT l.Id ,
          l.Title ,
          l.PaymentDate ,
          ...
          l.CustomerId 
     FROM Licenses l
    WHERE  l.PaymentDate < SYSDATE;


GRANT ALL ON vw_Unpayment TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION CountOfCustLic
(
  v_id IN NUMBER
)
RETURN NUMBER
...
BEGIN
   SELECT COUNT(*)  
     ...
     INTO v_count
     FROM Licenses 
    WHERE  Licenses.CustomerId = v_id;
   RETURN v_count;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON CountOfCustLic TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION CountOfLicenses
RETURN NUMBER
AS
   v_count NUMBER(10,0);
...
END;
/
GRANT ALL ON CountOfLicenses TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION SoftLicenseManagement.fn_diagramobjects
RETURN NUMBER
AUTHID DEFINER
AS
...
END;
/
GRANT ALL ON fn_diagramobjects TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION udf_TotalCostOfPurchasedLicenses
RETURN NUMBER
AS
   v_sum NUMBER(10,0) := ( SELECT SUM(S.Price)  
...
END;
/
GRANT ALL ON udf_TotalCostOfPurchasedLicenses TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE AddSubordinate
(
  v_ParentId IN NUMBER,
  v_Name IN NVARCHAR2,
  v_Email IN NVARCHAR2,
  v_Address IN NVARCHAR2,
...
BEGIN
   ...
   INSERT INTO Contacts
     ( NAME, Email, ADDRESS, Phone, ParentId )
     VALUES ( v_Name, v_Email, v_Address, v_Phone, v_ParentId );

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON AddSubordinate TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE Distancecontact
(
  v_contactID1 IN NUMBER,
  v_contactID2 IN NUMBER,
  v_result OUT FLOAT
)
AS
   v_contact1 UDT.GEOGRAPHY%TYPE;
   v_contact2 UDT.GEOGRAPHY%TYPE;
...
BEGIN
   ...
   SELECT location 
    ...
    WHERE  contact_id = v_contactID1;
   SELECT location 

     INTO v_contact2
     FROM ContactCoordinate 
    WHERE  contact_id = v_contactID2;= ( SELECT @contact1 . STDistance ( @contact2 ) / 1000 )  --SQLDEV: NOT RECOGNIZED

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON Distancecontact TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE DistanceUser
(
  v_userID1 IN NUMBER,
  v_userID2 IN NUMBER,
  v_result OUT FLOAT
...
AS
   v_user1 UDT.GEOGRAPHY%TYPE;
   v_user2 UDT.GEOGRAPHY%TYPE;
...
BEGIN
   ...
   SELECT location 
     ...
     INTO v_user1
     FROM UserLocation 
    WHERE  USER_ID = v_userID1;
   SELECT location 

     INTO v_user2
     FROM UserLocation 
    WHERE  USER_ID = v_userID2;= ( SELECT @user1 . STDistance ( @user2 ) / 1000 )  --SQLDEV: NOT RECOGNIZED

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON DistanceUser TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE SoftLicenseManagement.GetClosestContact
(
  v_contactId IN NUMBER
)
AS
   v_targetLocation UDT.GEOGRAPHY%TYPE;
...
BEGIN
   ...
   SELECT location 
     ...
     INTO v_targetLocation
     FROM ContactCoordinate 
    WHERE  contact_id = v_contactId;
   -- Получить координаты всех остальных контактов
   OPEN  v_cursor FOR
      SELECT cc.contact_id ,
             STDistance(v_targetLocation) distance  
        FROM ContactCoordinate cc
       WHERE  cc.contact_id <> v_contactId
...
END;
/
GRANT ALL ON GetClosestContact TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE MoveSubtree
(
  v_sourceID IN NUMBER,
  v_destinationID IN NUMBER
)
AS
...
BEGIN
   ...
   SELECT T.Id 
     FROM Contacts T
      ...
      UPDATE Contacts
         SET ParentId = v_destinationID
       WHERE  Id IN ( SELECT Id 
                      FROM CTE  )
   
      ;-- Перемещаем верхний перемещаемый узел
   -- UPDATE Tours
   -- SET ParentTourID = @destinationTourID
   --WHERE ID = @sourceTourID

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON MoveSubtree TO ROLE_SoftLicenseManagement;
...
BEGIN
   ...
   OPEN  v_cursor FOR
      WITH Subordinates AS ( SELECT Id ,
                                    NAME ,
                                    Email ,
                                    ADDRESS ,
                                    Phone ,
...
END;
/
GRANT ALL ON ShowSubordinates TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION SoftLicenseManagement.sp_alterdiagram
(
...
BEGIN
   ...
   SELECT diagram_id ,
     ...
     INTO v_DiagId,
          v_UIDFound
     FROM SoftLicenseManagement.sysdiagrams 
   ...
   END IF;
   -- update dds data			
   UPDATE SoftLicenseManagement.sysdiagrams
...
END;
/
GRANT ALL ON sp_alterdiagram TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION SoftLicenseManagement.sp_creatediagram
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL ,
  v_version IN NUMBER,
...
BEGIN
   ...
   END;
   END IF;
   INSERT INTO SoftLicenseManagement.sysdiagrams
...
END;
/
GRANT ALL ON sp_creatediagram TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION SoftLicenseManagement.sp_dropdiagram
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL 
)
...
BEGIN
   ...
   END;
   END IF;
   DELETE SoftLicenseManagement.sysdiagrams
...
END;
/
GRANT ALL ON sp_dropdiagram TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION SoftLicenseManagement.sp_helpdiagramdefinition
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL 
)
...
END;
/
GRANT ALL ON sp_helpdiagramdefinition TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE SoftLicenseManagement.sp_helpdiagrams
(
...
END;
/
GRANT ALL ON sp_helpdiagrams TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE FUNCTION SoftLicenseManagement.sp_renamediagram
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL ,
...
END;
/
GRANT ALL ON sp_renamediagram TO ROLE_SoftLicenseManagement;
/* Translation Extracted DDL For Required Objects*/
CREATE TABLE SoftLicenseManagement.sysdiagrams
(
...
/
CREATE SEQUENCE tt_SoftLicenseManagement.sy 
;
/
CREATE OR REPLACE TRIGGER 
 tt_TR_tLicenseManagement.sy    BEFORE INSERT 
   ON SoftLicenseManagement.sysdiagrams
   FOR EACH ROW
   BEGIN
      SELECT tt_SoftLicenseManagement.sy.NEXTVAL INTO :NEW.diagram_id
        FROM DUAL;
   END;
/


CREATE OR REPLACE FUNCTION SoftLicenseManagement.sp_upgraddiagrams
RETURN NUMBER
AS
...
BEGIN
   ...
   IF utils.object_id(N'dbo.sysdiagrams') IS NOT NULL THEN
    RETURN 0;
   END IF;
   DELETE FROM SoftLicenseManagement.sysdiagrams;
   ...
   BEGIN
      INSERT INTO SoftLicenseManagement.sysdiagrams
        ...
        ( SELECT UTILS.CONVERT_TO_VARCHAR2(dgnm.uvalue,128) ,
                 ...
                 dgdef.lvalue 
          FROM SoftLicenseManagement.dtproperties dgnm
                 JOIN SoftLicenseManagement.dtproperties dggd   ON dggd.property = 'DtgSchemaGUID'
                 AND dggd.objectid = dgnm.objectid
                 JOIN SoftLicenseManagement.dtproperties dgdef   ON dgdef.property = 'DtgSchemaDATA'
...
END;
/
GRANT ALL ON sp_upgraddiagrams TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_AddCustomer
(
  v_name IN NVARCHAR2,
  v_email IN NVARCHAR2,
  v_address IN NVARCHAR2 DEFAULT NULL ,
  v_phone IN NVARCHAR2,
  v_ownerId OUT NUMBER
)
AS
   v_contactId NUMBER(10,0);

BEGIN

   INSERT INTO SoftLicenseManagement.Contacts
     ( NAME, Email, ADDRESS, Phone )
     VALUES ( v_name, v_email, v_address, v_phone );
   v_contactId := utils.getidentity ;
   INSERT INTO SoftLicenseManagement.Customers
     ( ContactId )
     VALUES ( v_contactId );
   v_ownerId := utils.getidentity ;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON usp_AddCustomer TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_AddLicense
(
  v_title IN NVARCHAR2,
  v_expirydate IN DATE,
  v_softwareId IN NUMBER,
  v_customerId IN NUMBER,
  v_licenseId OUT NUMBER
)
AS

BEGIN

   INSERT INTO SoftLicenseManagement.Licenses
     ( Title, ExpiryDate, SoftwareId, CustomerId )
     VALUES ( v_title, v_expirydate, v_softwareId, v_customerId );
   v_licenseId := utils.getidentity ;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON usp_AddLicense TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_AddOwner
(
  v_name IN NVARCHAR2,
  v_email IN NVARCHAR2,
  v_address IN NVARCHAR2,
...
BEGIN
   ...
   INSERT INTO SoftLicenseManagement.Contacts
     ...
     VALUES ( v_name, v_email, v_address, v_phone );
   v_contactId := utils.getidentity ;
   INSERT INTO SoftLicenseManagement.Owners
     ( ContactId )
     VALUES ( v_contactId );
   v_ownerId := utils.getidentity ;
...
END;
/
GRANT ALL ON usp_AddOwner TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_AddSoftware
(
  v_name IN NVARCHAR2,
  v_version IN NVARCHAR2,
  v_price IN NUMBER,
  v_ownerId IN NUMBER,
  v_date IN DATE,
  v_softwareId OUT NUMBER
)
AS

BEGIN

   INSERT INTO SoftLicenseManagement.Software
     ( NAME, Version, Price, OwnerId, DateCreated )
     VALUES ( v_name, v_version, v_price, v_ownerId, v_date );
   v_softwareId := utils.getidentity ;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON usp_AddSoftware TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_Cross CREATE PROCEDURE usp_Cross AS BEGIN SELECT * FROM UserLocation WHERE location . STIntersects ( geography :: Point ( 51.5072 , - 0.1276 , 4326 ) . STBuffer ( 5000 ) ) = 1 ;  --SQLDEV: NOT RECOGNIZED
AS
...
END;
/
GRANT ALL ON usp_Cross TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE SoftLicenseManagement.usp_DeleteLicense
(
  v_id IN NUMBER
)
AS
...
BEGIN
   ...
   DELETE SoftLicenseManagement.Licenses
...
END;
/
GRANT ALL ON usp_DeleteLicense TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_EditLicense
(
  v_id IN NUMBER,
  v_title IN NVARCHAR2,
  v_expirydate IN DATE,
...
BEGIN
   ...
   MERGE INTO S 
   USING (SELECT S.ROWID row_id, v_title, v_expirydate, v_softwareId, v_customerId
   FROM S ,SoftLicenseManagement.Licenses S 
    WHERE S.Id = v_id) src
   ON ( S.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET S.Title = v_title,
                                S.ExpiryDate = v_expirydate,
                                S.SoftwareId = v_softwareId,
                                S.CustomerId = v_customerId;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON usp_EditLicense TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_GetLicenses
--For app---
...
BEGIN
   ...
   OPEN  v_cursor FOR
      SELECT l.Id ,
             ...
             l.SoftwareId ,
             l.CustomerId 
        FROM SoftLicenseManagement.Licenses l ;
      DBMS_SQL.RETURN_RESULT(v_cursor);

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON usp_GetLicenses TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE PROCEDURE usp_GetLicensesExpireNextMonth
AS
   v_cursor SYS_REFCURSOR;
...
BEGIN
   ...
   OPEN  v_cursor FOR
      SELECT l.Id ,
             ...
             l.CustomerId 
        FROM SoftLicenseManagement.Licenses l
       WHERE  utils.datediff('MONTH', SYSDATE, l.ExpiryDate) = 1 ;
      DBMS_SQL.RETURN_RESULT(v_cursor);

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON usp_GetLicensesExpireNextMonth TO ROLE_SoftLicenseManagement;
CREATE OR REPLACE TRIGGER trg_InsertOwners
   AFTER INSERT
   ON Owners
   FOR EACH ROW
DECLARE
...
CREATE OR REPLACE TRIGGER Licenses_INSERT
   AFTER INSERT
   ON Licenses
   FOR EACH ROW
...
BEGIN
   INSERT INTO LicensesHistory
     ( LicenseId, Title, PaymentDate, ExpiryDate, SoftwareId, CustomerId )
     ( SELECT :NEW.Id ,
              :NEW.Title ,
              :NEW.PaymentDate ,
              :NEW.ExpiryDate ,
...
alter session set current_schema=SoftLicenseManagement;
set define off
PROMPT Creating Foreign Key Constraint FK_Licenses_Software on table Software...
ALTER TABLE Licenses
ADD CONSTRAINT FK_Licenses_Software FOREIGN KEY
(
  SoftwareId
)
REFERENCES Software
...
PROMPT Creating Foreign Key Constraint FK_Software_Owners on table Owners...
ALTER TABLE Software
ADD CONSTRAINT FK_Software_Owners FOREIGN KEY
(
  OwnerId
)
REFERENCES Owners
...
PROMPT Creating Foreign Key Constraint FK_Customers_Contacts on table Contacts...
ALTER TABLE Customers
ADD CONSTRAINT FK_Customers_Contacts FOREIGN KEY
(
  ContactId
)
REFERENCES Contacts
...
PROMPT Creating Foreign Key Constraint FK__Contacts__Manage__2739D489 on table Contacts...
ALTER TABLE Contacts
ADD CONSTRAINT FK__Contacts__Manage__2739D489 FOREIGN KEY
(
  ParentId
)
REFERENCES Contacts
...
PROMPT Creating Foreign Key Constraint FK_Licenses_Customers on table Customers...
ALTER TABLE Licenses
ADD CONSTRAINT FK_Licenses_Customers FOREIGN KEY
(
  CustomerId
)
...
PROMPT Creating Foreign Key Constraint FK__UserLocat__user___02FC7413 on table Contacts...
ALTER TABLE ContactCoordinate
ADD CONSTRAINT FK__UserLocat__user___02FC7413 FOREIGN KEY
(
  contact_id
)
REFERENCES Contacts
...
PROMPT Creating Foreign Key Constraint FK_Owners_Contacts on table Contacts...
ALTER TABLE Owners
ADD CONSTRAINT FK_Owners_Contacts FOREIGN KEY
(
  ContactId
)
REFERENCES Contacts
...
ALTER VIEW vw_InactiveLicenses COMPILE;

ALTER VIEW vw_ActiveLicenses COMPILE;

ALTER VIEW vw_Unpayment COMPILE;
